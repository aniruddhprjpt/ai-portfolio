...
const WebThreads = ({
  ...
  useEffect(() => {
    ...
    const rgb1 = hexToRgb(color1); u.uColor1.value[0]=rgb1[0]; u.uColor1.value[1]=rgb1[1]; u.uColor1.value[2]=rgb1[2];
    const rgb2 = hexToRgb(color2); u.uColor2.value[0]=rgb2[0]; u.uColor2.value[1]=rgb2[1]; u.uColor2.value[2]=rgb2[2];
    const rgb3 = hexToRgb(color3); u.uColor3.value[0]=rgb3[0]; u.uColor3.value[1]=rgb3[1]; u.uColor3.value[2]=rgb3[2];
    const bg = hexToRgb(backgroundColor); u.uBackgroundColor.value[0]=bg[0]; u.uBackgroundColor.value[1]=bg[1]; u.uBackgroundColor.value[2]=bg[2];
